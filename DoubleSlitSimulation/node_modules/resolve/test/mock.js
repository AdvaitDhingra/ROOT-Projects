...
test('mock', function(t) {
  ...
  function opts(basedir) {
    return {
      ...
      isDirectory : function(dir, cb) { cb(null, !!dirs[path.resolve(dir)]); },
      readFile : function(file, cb) { cb(null, files[path.resolve(file)]); },
      realpath : function(file, cb) { cb(null, file); }
    };
  }
  ...
  resolve('../baz', opts('/foo/bar'), function(err, res) {
    t.equal(err.message, "Cannot find module '../baz' from '" +
...
test('mock from package', function(t) {
  ...
  function opts(basedir) {
    return {
      ...
      isFile : function(
          file,
          cb) { cb(null, Object.prototype.hasOwnProperty.call(files, file)); },
      isDirectory : function(dir, cb) { cb(null, !!dirs[path.resolve(dir)]); },
      'package' : {main : 'bar'},
      readFile : function(file, cb) { cb(null, files[file]); },
      realpath : function(file, cb) { cb(null, file); }
    };
  }
...
test('readPackage', function(t) {
  ...
  t.test('with readFile and readPackage', function(st) {
    ...
    resolve('bar', options, function(err) {
      st.throws(function() { throw err; }, TypeError,
