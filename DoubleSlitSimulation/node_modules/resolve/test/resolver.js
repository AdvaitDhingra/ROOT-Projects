...
test('cup', function(t) {
  ...
  resolve('./cup', {
    ...
    filename : path.join(dir, 'cupboard.js')
          ...
          function(err, res) {
            t.equal(err.message, "Cannot find module './cup' from '" +
...
test('mug', function(t) {
  ...
  resolve('./mug', {basedir : dir, extensions : [ '.js', '.coffee' ]},
          function(err, res) { t.equal(res, path.join(dir, '/mug.js')); });
});
...
test('async: #121 - treating an existing file as a dir when no basedir',
     function(t) {
       ...
       t.test('with a fake directory', function(st) {
         ...
         resolve('./' + testFile + '/blah', function(err, res, pkg) {
           ...
           st.equal(err && err.code, 'MODULE_NOT_FOUND',
                    'error code matches require.resolve');
           st.equal(err && err.message,
