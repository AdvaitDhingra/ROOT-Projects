...
var winParseTests = [
  ...
  [
    {root : '\\', dir : '\\foo', base : 'C:', ext : '', name : 'C:'},
    '\\foo\\C:'
  ],
...
var unixParseTests = [
  ...
  [ {root : '', dir : '.', base : 'file', ext : '', name : 'file'}, './file' ],
  [
    {root : '', dir : '', base : 'C:\\foo', ext : '', name : 'C:\\foo'},
    'C:\\foo'
  ]
];

var unixSpecialCaseFormatTests = [
  [ {dir : 'some/dir'}, 'some/dir/' ], [ {base : 'index.html'}, 'index.html' ],
  [ {}, '' ]
];
...
function checkErrors(parse) {
  errors.forEach(function(errorCase) {
    try {
      ...
      assert.ok(errorCase.message.test(err.message),
...
function checkParseFormat(parse, testCases) {
  testCases.forEach(function(
      testCase) { assert.deepEqual(parse(testCase[1]), testCase[0]); });
}
